package com.bootcamp.electvote.config;

import com.bootcamp.electvote.repository.VoterRepository;
import com.bootcamp.electvote.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/elections/*/results").permitAll()
                // Admin only
    ...
    public UserDetailsService userDetailsService() {
        return username -> voterRepository.findByEmail(username)
                .map(voter -> org.springframework.security.core.userdetails.User.builder()
                        .username(voter.getEmail())
                        .password(voter.getPassword())
                        .roles(voter.getRole().name())
                        .build())
